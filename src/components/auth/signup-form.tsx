  ...
  if (success) {
    return (
      <div className="w-full max-w-md fade-in-up">
        <div className="glass-card rounded-2xl p-8 sm:p-10 shadow-2xl shadow-black/30 text-center">
          {/* Checkmark Icon */}
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 glow-amber">
            <svg
          ...
          <Link
            href="/login"
            className="
              inline-flex items-center gap-1.5 font-body text-sm text-primary
              underline underline-offset-4 transition-colors duration-200
              hover:text-amber-soft
            "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="glass-card rounded-2xl p-8 sm:p-10 shadow-2xl shadow-black/30">
        ...
        <div className="mb-8 text-center">
          <h1 className="font-heading text-3xl font-bold tracking-tight mb-2">
            Create your <span className="text-gradient">PropScout AI</span> account
          </h1>
          <p className="font-body text-sm text-muted-foreground">
            Start finding high-yield Dutch rental properties
          </p>
        </div>
