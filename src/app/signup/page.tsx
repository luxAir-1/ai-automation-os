...
export const metadata = {
  title: 'Registreren — PropScout AI',
}
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-md px-12 text-center fade-in">
          ...
          <p className="font-body text-lg text-muted-foreground leading-relaxed mb-8">
            Sluit je aan bij 500+ Nederlandse investeerders die AI gebruiken om hoog-rendement huurwoningen te ontdekken.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="flex -space-x-2">
                {[0, 1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-8 w-8 rounded-full border-2 border-surface-1 bg-surface-3"
                    style={{
                      background: `linear-gradient(135deg, hsl(${38 + i * 30} 60% 40%), hsl(${38 + i * 30} 70% 55%))`,
                    }}
                  />
                ))}
              </div>
              <span className="font-body text-sm text-muted-foreground">
                500+ actieve investeerders
              </span>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 text-center">
              <div>
                <p className="font-heading text-xl font-bold text-gradient">8.2%</p>
                <p className="font-body text-xs text-muted-foreground">Gem. Rendement</p>
              </div>
              <div className="h-8 w-px bg-border" />
              <div>
                <p className="font-heading text-xl font-bold text-gradient">2.400+</p>
                <p className="font-body text-xs text-muted-foreground">Woningen</p>
              </div>
              <div className="h-8 w-px bg-border" />
              <div>
                <p className="font-heading text-xl font-bold text-gradient">12</p>
                <p className="font-body text-xs text-muted-foreground">Steden</p>
              </div>
            </div>
          </div>
        </div>
